...
namespace ProjetoMVC.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(ProjetoMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Marcas != null ? 
                          ...
                          Problem("Entity set 'ProjetoMVCContext.Marcas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetoMVCContext.Marcas'  is null.");
            }
            var marcaModel = await _context.Marcas.FindAsync(id);
            if (marcaModel != null)
            {
